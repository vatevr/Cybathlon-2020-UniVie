...
import pyriemann
import numpy as np
from Pipeline.src.classifier.riemannianClassifier.features import TSSF
...
class riemannianClassifier(BaseEstimator):
    ...
    def load_self(self):
        clf_filename = self.savePath + "classifier.sav"
        le_filename = self.savePath + "le.sav"
        param_filename = self.savePath + "params.sav"
