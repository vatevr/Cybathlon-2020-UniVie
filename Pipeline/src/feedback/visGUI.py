...
class Window(QtWidgets.QMainWindow):
    ...
    def updateSignal(self):
        ...
        self.progressRight.setStyleSheet(self.progressColor(sample[1]))
        self.progressRight.setValue(sample[1])
        """
        self.progressLight.setStyleSheet(self.progressColor(sample[2]))
        self.progressLight.setValue(sample[2])

        self.progressRest.setStyleSheet(self.progressColor(sample[3]))
